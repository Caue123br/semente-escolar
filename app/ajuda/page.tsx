...
const categorias = [
  ...
  },
  {
    ...
    artigos: 14,
    desc: "Rascunhos, histórico e abertura manual do WhatsApp",
  },
  {
    icon: Settings,
...
const populares = [
  ...
  { titulo: "Como preparar e concluir uma mensagem no WhatsApp?", categoria: "WhatsApp" },
  { titulo: "Como preparar um registro para emissão externa de NFS-e?", categoria: "Financeiro" },
