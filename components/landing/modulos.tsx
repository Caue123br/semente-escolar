...
const modulos = [
  ...
  { icon: MessageSquare, nome: "WhatsApp", desc: "Rascunhos e abertura para envio externo", cor: "from-green-500 to-emerald-500" },
  ...
  { icon: FileText, nome: "Controle fiscal", desc: "Registros internos para conferência", cor: "from-indigo-500 to-violet-500" },
  ...
  { icon: Heart, nome: "Portal dos Pais", desc: "Acesso web para responsáveis", cor: "from-rose-400 to-pink-500" },
